...
const QString BITCOIN_IPC_PREFIX("Subatomchain:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Subatomchain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Subatomchain: click-to-pay handler");
    else
...
{
    // clicking on Subatomchain: URLs creates FileOpen events on the Mac:
